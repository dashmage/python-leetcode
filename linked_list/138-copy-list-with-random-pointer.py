...
class Solution:
    # two passes, first one creates all the Nodes and sets up the hashmap
    # second one creates both next and random pointers by referring to the hashmap
    def copyRandomList(self, head: Node | None) -> Node | None:
        # hashmap between node in old list to node in copy
